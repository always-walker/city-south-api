...
namespace CitySouth.Web.Controllers
{
    public class WaterAndElectricityController : BaseController
    {
        ...
        [HttpPost]
        [Author("water-electricity.export")]
        public HttpResponseMessage Export([FromBody]SearchModel model)
        {
            ...
            var list = from b in a
                       select new
                       {
                           ...
                           房号 = b.HouseNo,
                           业主姓名 = b.OwnerName,
                           缴费人姓名 = b.waterAndE.PayerName,
                           联系电话 = b.Phone,
                           费用类型 = b.waterAndE.FeeName,
                           单价 = b.waterAndE.UnitPrice,
                           抄表月份 = b.waterAndE.FeeDate,
                           上月表量 = b.waterAndE.LastQuantity,
                           本月表量 = b.waterAndE.Quantity,
                           本月用量 = b.waterAndE.Quantity - b.waterAndE.LastQuantity,
                           分摊量 = b.waterAndE.ShareQuantity,
                           缴费金额 = b.waterAndE.Amount,
                           缴费时间 = b.waterAndE.CreateTime,
                           支付时间 = b.waterAndE.PayTime,
                           收据号码 = b.waterAndE.ReceiptNo,
                           凭证号码 = b.waterAndE.VoucherNo,
                           操作员 = b.waterAndE.OprationName,
                           缴费方式 = b.waterAndE.PayWay,
                           备注 = b.waterAndE.Remark
                       };
            ...
            response.Content.Headers.ContentDisposition = new ContentDispositionHeaderValue("attachment")
            {
                FileName = HttpUtility.UrlEncode("水电费.xlsx")
            };
            return response;
        }
    }
